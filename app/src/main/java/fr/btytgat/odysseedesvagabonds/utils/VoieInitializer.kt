...
class VoieInitializer {

    companion object{
        val categoryVoieElement = "Voie des éléments"
        val nbVoieElement = 2

        fun voieBestiale(database: DatabaseReference): String{
            ...
            val talentGroup1 = TalentGroup(
                ...
                1,
                listOf(talent1_1.uuid, talent1_2.uuid, talent1_3.uuid, talent1_4.uuid)
            )
            talentGroup1.let {
            ...
            val talentGroup3 = TalentGroup(
                ...
                "#3 - Animal de combat",
                3,
                listOf(talent3_1.uuid, talent3_2.uuid)
            )
            talentGroup3.let {
                Log.i("DATABASE", "create talentGroup - ${it.uuid.toString()}")
                database.child(DatabaseUtils.KEY_SYSTEM).child(DatabaseUtils.KEY_TALENT_GROUPS)
        ...
        fun voieProtecteur(database: DatabaseReference): String {
        ...
        fun voieNature(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
        ...
        fun voieVegetaux(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
                "Info - Vie sylvestre",
            ...
            val talentGroup2 = TalentGroup(
                ...
                2,
                listOf(talent2_1.uuid, talent2_2.uuid)
            )
            talentGroup2.let {
                Log.i("DATABASE", "create talentGroup - ${it.uuid.toString()}")
                database.child(DatabaseUtils.KEY_SYSTEM).child(DatabaseUtils.KEY_TALENT_GROUPS)
        ...
        fun voieArtillerie(database: DatabaseReference): String {
            val infoTalent1_1 = Info(
                UUID.randomUUID().toString(),
            ...
            val talentGroup3 = TalentGroup(
                ...
                3,
                listOf(talent3_1.uuid, talent3_2.uuid, talent3_3.uuid)
            )
            talentGroup3.let {
                Log.i("DATABASE", "create talentGroup - ${it.uuid.toString()}")
                database.child(DatabaseUtils.KEY_SYSTEM).child(DatabaseUtils.KEY_TALENT_GROUPS)
            ...
            val talentGroup5 = TalentGroup(
                ...
                "#5 - Artilleur vétéran",
                5,
                listOf(talent5_1.uuid, talent5_2.uuid, talent5_3.uuid)
            )
            talentGroup5.let {
                Log.i("DATABASE", "create talentGroup - ${it.uuid.toString()}")
                database.child(DatabaseUtils.KEY_SYSTEM).child(DatabaseUtils.KEY_TALENT_GROUPS)
        ...
        fun voieChimiste(database: DatabaseReference): String {
            val infoTalent1_1 = Info(
                UUID.randomUUID().toString(),
        ...
        fun voieTireur(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
            ...
            val talentGroup4 = TalentGroup(
                ...
                4,
                listOf(talent2.uuid, talent4_2.uuid)
            )
            talentGroup4.let {
                Log.i("DATABASE", "create talentGroup - ${it.uuid.toString()}")
                database.child(DatabaseUtils.KEY_SYSTEM).child(DatabaseUtils.KEY_TALENT_GROUPS)
        ...
        fun voieMecanismes(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
                "Info - Mécanicien",
        ...
        fun voieFeu(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
        ...
        fun voieTerre(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
                "Info - Esprit de Gaia",
        ...
        fun voieEau(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
        ...
        fun voieAir(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
        ...
        fun voieArcane(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
        ...
        fun voieMagieUniverselle(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
                "Info - Savoir magique",
        ...
        fun voieLumiere(database: DatabaseReference): String {
            val infoTalent1 = Info(
                UUID.randomUUID().toString(),
